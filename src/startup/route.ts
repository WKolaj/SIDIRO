...
import subscriptionRoute from "../routes/subscription/subscription";
...
export default async function(app: Express) {
  ...
  app.use("/customApi/subscription", subscriptionRoute);
  logger.info("Subscription route initialized");
