      ...
      hostTenant: {
        testServiceContainerAssetId: {
            ...
            assetIds: [
              {
                assetId: "assetId11",
                aspectId: "aspect111",
                variableName: "variable1111",
                multiplier: 0.001,
              },
              {
                assetId: "assetId12",
                aspectId: "aspect121",
                variableName: "variable1211",
                multiplier: 0.002,
              },
              {
                assetId: "assetId13",
                aspectId: "aspect131",
                variableName: "variable1311",
                multiplier: 0.003,
              },
            ],
            powerLosses: 123,
          ...
          "testLoadmonitoringServiceId2.service.config.json": {
            ...
            mailingList: [
              {
                email: "testEmail21@test.mail.com",
                language: "en",
              },
              {
                email: "testEmail22@test.mail.com",
                language: "pl",
              },
              {
                email: "testEmail23@test.mail.com",
                language: "en",
              },
            ],
            interval: 600,
